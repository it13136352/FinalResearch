...
public class StaticQueryOut {
    ...
    public ArrayList<String> Ag() throws IOException
    {
          ArrayList Ag =new ArrayList();
        FileManager.get().addLocatorClassLoader(Main.class.getClassLoader());
           Model model = FileManager.get().loadModel("c:/owl/data.owl");
    ...
    public ArrayList<String> Co() throws IOException
    {
    ...
    public ArrayList<String> Esp() throws IOException
    {
    ...
    public ArrayList<String> Exp() throws IOException
    {
    ...
    public ArrayList<String> Op() throws IOException
    {
     ...
     public ArrayList<String> Ed() throws IOException
    {
        ...
        try 
        {
                 ...
                 while (results6.hasNext()) 
            {
                ...
                Literal name6 = soln1.getLiteral("ed");
